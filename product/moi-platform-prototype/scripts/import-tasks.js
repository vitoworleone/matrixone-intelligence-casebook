...
window.IMPORT_TASKS_DISPLAY = {
      ...
      // ---------- 对象存储 ----------
      't_demo_aliyun_oss': { name: '【示例】阿里云 OSS 营销素材同步', connector: '营销素材库 · 阿里云 OSS', connType: '阿里云 OSS（对象存储）', dataType: '非结构化', mode: '周期性', target: 'default / 示例库 / 营销素材卷', status: '载入中', created: '2026-05-25 13:05', lastRun: '2026-05-25 14:00', schedule: '每小时', totalRuns: 24, totalRows: '186 个文件', totalSize: '4.2 GB', syncStrategy: 'incremental', incremental: { field: '对象 LastModified', lookback: '1 小时' }, extra: [{ label: 'Bucket', value: 'marketing-assets-cn-hangzhou' },{ label: '路径', value: 'marketing-assets/2026/' },{ label: '文件类型', value: 'PDF, PNG, JPG, MP4, ZIP' }], fileMeta: '路径 marketing-assets/2026/ · 监听对象事件（OSS Event Notification）',
        files: [
      ...
      't_demo_obs': { name: '【示例】华为云 OBS 合规报告归档', connector: '政企归档 · 华为云 OBS', connType: '华为云 OBS（对象存储）', dataType: '非结构化', mode: '周期性', target: 'default / 示例库 / 合规归档卷（导出方向）', status: '载入失败', created: '2026-05-25 13:20', lastRun: '2026-05-25 03:00', schedule: '每周一 03:00', totalRuns: 12, totalRows: '48 份报告', totalSize: '1.4 GB', syncStrategy: 'full', extra: [{ label: 'Bucket', value: 'gov-archive-bj（华北-北京四）' },{ label: '方向', value: '导出（MOI → OBS）' },{ label: '加密', value: 'SSE-KMS' }], fileMeta: '每周导出审计报告到 OBS 长期保留 7 年',
        files: [
      ...
      // ---------- 数据库 ----------
      't_demo_matrixone': { name: '【示例】MatrixOne 用户行为表同步', connector: 'MatrixOne 生产集群', connType: 'MatrixOne（数据库）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / user_events', status: '等待中', created: '2026-05-25 13:30', lastRun: '2026-05-25 14:00', schedule: '每小时', totalRuns: 96, totalRows: '8,420,000', totalSize: '1.6 GB', syncStrategy: 'incremental', incremental: { field: 'event_time', lookback: '1 小时' }, schemaMeta: '源表 moi_warehouse.user_events · MO MO 实时写入 + 增量拉取',
        schema: [
      ...
      't_demo_mongodb': { name: '【示例】MongoDB 商品目录同步', connector: 'Intelie 传感器数据', connType: 'MongoDB（数据库）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / products', status: '等待中', created: '2026-05-25 13:45', lastRun: '2026-05-25 14:00', schedule: '每小时', totalRuns: 96, totalRows: '156,000', totalSize: '62 MB', syncStrategy: 'incremental', incremental: { field: 'updatedAt', lookback: '1 小时' }, schemaMeta: 'Collection products · JSON 文档展平 + 嵌套字段保留为 JSON',
        schema: [
      ...
      't_demo_hive': { name: '【示例】Hive DWD 周报加工', connector: 'NESR 数据仓库 Hive', connType: 'Hive（数据库）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / dwd_weekly_kpi', status: '等待中', created: '2026-05-25 13:50', lastRun: '2026-05-25 04:00', schedule: '每周一 04:00', totalRuns: 12, totalRows: '8,400', totalSize: '12 MB', syncStrategy: 'incremental', incremental: { field: 'partition stat_week', lookback: '0' }, schemaMeta: '源表 dw_dwd.dwd_well_kpi_weekly · 按分区 stat_week 拉取',
        schema: [
      ...
      't_demo_sqlserver': { name: '【示例】SQL Server 报价单同步', connector: '汉得 Topcast · SQL Server', connType: 'SQL Server（数据库）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / quote_orders', status: '载入中', created: '2026-05-25 13:55', lastRun: '2026-05-25 14:00', schedule: '每 30 分钟', totalRuns: 280, totalRows: '38,200', totalSize: '14 MB', syncStrategy: 'incremental', incremental: { field: 'LastModified', lookback: '30 分钟' }, schemaMeta: '源表 TopcastQuote.dbo.QUOTE_HDR · 报价单主表',
        schema: [
      ...
      // ---------- 邮件 ----------
      't_demo_gmail': { name: '【示例】Gmail 客户邮件载入', connector: '客户服务 Gmail 收件箱', connType: 'Gmail（邮件）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / gmail_messages', status: '等待中', created: '2026-05-25 14:15', lastRun: '2026-05-25 14:00', schedule: '每 5 分钟', totalRuns: 8640, totalRows: '48,200', totalSize: '186 MB', syncStrategy: 'incremental', incremental: { field: 'internalDate', lookback: '15 分钟' }, schemaMeta: '邮件元数据 + 正文文本（附件落 Volume 不入此表）',
        schema: [
      ...
      't_demo_outlook': { name: '【示例】Outlook 法务邮件载入', connector: '法务 Outlook 收件箱', connType: 'Outlook（邮件）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / outlook_messages', status: '等待中', created: '2026-05-25 14:20', lastRun: '2026-05-25 14:00', schedule: '每 15 分钟', totalRuns: 2880, totalRows: '12,800', totalSize: '52 MB', syncStrategy: 'incremental', incremental: { field: 'receivedDateTime', lookback: '30 分钟' }, schemaMeta: '通过 Outlook REST API 读取，含分类标签',
        schema: [
      ...
      't_demo_ms365_graph': { name: '【示例】Microsoft 365 全员邮件采集', connector: '全员 Microsoft 365 邮箱', connType: 'Microsoft 365 (Graph)（邮件）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / ms365_messages', status: '回填中', created: '2026-05-25 14:25', lastRun: '2026-05-25 14:00', schedule: '每 5 分钟', totalRuns: 8640, totalRows: '1,560,000', totalSize: '6.2 GB', syncStrategy: 'incremental', incremental: { field: 'receivedDateTime', lookback: '15 分钟' }, backfill: { enabled: true, progress: '38%', startDate: '2025-01-01', batchSize: '1 天', batchInterval: '5 秒', window: '00:00 - 08:00' }, schemaMeta: '通过 Graph delta query 增量；按用户邮箱白名单过滤',
        schema: [
      ...
      't_demo_wecom_mail': { name: '【示例】企业微信邮箱采集', connector: '企业微信项目邮箱', connType: '企业微信邮箱（邮件）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / wecom_mail_messages', status: '等待中', created: '2026-05-25 14:30', lastRun: '2026-05-25 14:00', schedule: '每 10 分钟', totalRuns: 4320, totalRows: '8,600', totalSize: '36 MB', syncStrategy: 'incremental', incremental: { field: 'mail_date', lookback: '30 分钟' }, schemaMeta: 'IMAP 拉取 + 标准邮件解析',
        schema: [
      ...
      't_demo_qq_mail': { name: '【示例】QQ 邮箱采集', connector: '运营 QQ 邮箱', connType: 'QQ 邮箱（邮件）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / qq_mail_messages', status: '载入失败', created: '2026-05-25 14:35', lastRun: '2026-05-25 14:00', schedule: '每 10 分钟', totalRuns: 4320, totalRows: '3,400', totalSize: '14 MB', syncStrategy: 'incremental', incremental: { field: 'mail_date', lookback: '30 分钟' }, schemaMeta: 'IMAP/POP3 拉取',
        schema: [
          { name: 'message_id', type: 'VARCHAR(256)', pk: true, nullable: false, desc: 'Message-ID' },
          { name: 'from_addr',  type: 'VARCHAR(256)', pk: false, nullable: false, desc: '发件人' },
          { name: 'subject',    type: 'VARCHAR(512)', pk: false, desc: '主题' },
      ...
      't_demo_imap': { name: '【示例】内部 IMAP 邮箱采集', connector: '内部 IMAP 邮箱', connType: 'IMAP/SMTP 通用（邮件）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / internal_mail', status: '等待中', created: '2026-05-25 14:40', lastRun: '2026-05-25 14:00', schedule: '每小时', totalRuns: 720, totalRows: '4,200', totalSize: '18 MB', syncStrategy: 'incremental', incremental: { field: 'received_at', lookback: '2 小时' }, schemaMeta: '兜底 IMAP/SMTP，适配任意标准邮件服务器',
        schema: [
          { name: 'message_id', type: 'VARCHAR(256)', pk: true, nullable: false, desc: 'Message-ID' },
          { name: 'from_addr',  type: 'VARCHAR(256)', pk: false, nullable: false, desc: '发件人' },
          { name: 'to_addrs',   type: 'JSON',     pk: false, desc: '收件人列表' },
      ...
      // ---------- API ----------
      't_demo_rest_api': { name: '【示例】天气 API 拉取', connector: 'Fiix CMMS 维修系统', connType: 'REST API', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / weather_hourly', status: '等待中', created: '2026-05-25 14:50', lastRun: '2026-05-25 14:00', schedule: '每小时', totalRuns: 720, totalRows: '20,160', totalSize: '4.2 MB', syncStrategy: 'incremental', incremental: { field: 'obs_time', lookback: '2 小时' }, schemaMeta: 'GET /weather?city=...&hour=... · JSON 数据路径 data.observations',
        schema: [
      ...
      't_demo_sharepoint': { name: '【示例】SharePoint 问卷文档载入', connector: '有临医药 · SharePoint 站点', connType: 'SharePoint（文件协议）', dataType: '非结构化', mode: '周期性', target: 'default / 示例库 / 问卷文档卷', status: '等待中', created: '2026-05-25 15:10', lastRun: '2026-05-25 12:00', schedule: '每 6 小时', totalRuns: 120, totalRows: '420 份问卷', totalSize: '186 MB', syncStrategy: 'incremental', incremental: { field: 'Modified', lookback: '6 小时' }, extra: [{ label: '站点', value: 'youlin.sharepoint.com/sites/cro-agent' },{ label: '文档库', value: 'Documents / 问卷/2026' }], fileMeta: '中心研究员上传 PDF/Word 问卷',
        files: [
      ...
      't_demo_smb': { name: '【示例】NAS 部门资料同步', connector: '集团 NAS · SMB 共享', connType: 'NAS (SMB/CIFS)（文件协议）', dataType: '非结构化', mode: '周期性', target: 'default / 示例库 / 部门资料卷', status: '等待中', created: '2026-05-25 15:15', lastRun: '2026-05-25 13:00', schedule: '每小时', totalRuns: 720, totalRows: '2,400 个文件', totalSize: '12 GB', syncStrategy: 'incremental', incremental: { field: '文件 mtime', lookback: '2 小时' }, extra: [{ label: '共享', value: '\\\\nas01\\department-data' },{ label: 'SMB 版本', value: 'SMB 3.0' }], fileMeta: '各部门 Excel/PPT/Word 文档；按部门子目录组织',
        files: [
      ...
      // ---------- 消息队列 ----------
      't_demo_kafka': { name: '【示例】Kafka GPS 流实时摄取', connector: 'CDG GPS 流 · Kafka', connType: 'Apache Kafka（消息队列）', dataType: '结构化', mode: '实时', target: 'default / 示例库 / gps_events', status: '载入中', created: '2026-05-25 15:20', lastRun: '实时', schedule: '常驻消费', totalRuns: '—', totalRows: '8,640,000', totalSize: '2.8 GB', syncStrategy: 'incremental', incremental: { field: 'Kafka offset', lookback: '5 分钟' }, schemaMeta: 'topic: taxi.gps.* · consumer group moi-gps-ingest · 微批 5s 写入',
        schema: [
      ...
      't_demo_mqtt': { name: '【示例】MQTT IoT 设备遥测', connector: 'IoT 设备遥测 · MQTT', connType: 'MQTT（消息队列）', dataType: '结构化', mode: '实时', target: 'default / 示例库 / iot_telemetry', status: '载入中', created: '2026-05-25 15:25', lastRun: '实时', schedule: '常驻订阅', totalRuns: '—', totalRows: '12,400,000', totalSize: '3.6 GB', syncStrategy: 'incremental', incremental: { field: 'ts', lookback: '10 分钟' }, schemaMeta: 'topic: iot/+/telemetry · QoS 1 · 微批 10s 写入',
        schema: [
      ...
      't_demo_rabbitmq': { name: '【示例】RabbitMQ 通知事件消费', connector: '通知服务 · RabbitMQ', connType: 'RabbitMQ（消息队列）', dataType: '结构化', mode: '实时', target: 'default / 示例库 / notification_events', status: '等待中', created: '2026-05-25 15:30', lastRun: '实时', schedule: '常驻消费', totalRuns: '—', totalRows: '42,000', totalSize: '18 MB', syncStrategy: 'incremental', incremental: { field: 'queue offset', lookback: '5 分钟' }, schemaMeta: 'queue: moi.notifications · exchange: notify.direct',
        schema: [
      ...
      't_demo_oracle_erp': { name: '【示例】Oracle ERP Cloud GL 同步', connector: 'Oracle ERP Cloud · 集团', connType: 'Oracle ERP Cloud（企业应用）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / erp_gl_balances', status: '等待中', created: '2026-05-25 15:40', lastRun: '2026-05-25 05:00', schedule: '每天 05:00', totalRuns: 30, totalRows: '36,800', totalSize: '14 MB', syncStrategy: 'incremental', incremental: { field: 'LastUpdateDate', lookback: '1 天' }, schemaMeta: 'REST API /fscmRestApi/resources/11.13.18.05/generalLedgerBalances',
        schema: [
      ...
      't_demo_kingdee': { name: '【示例】金蝶 K3 物料主数据同步', connector: '集团 · 金蝶 K/3 Cloud', connType: '金蝶 K/3 Cloud（企业应用）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / kingdee_materials', status: '等待中', created: '2026-05-25 15:50', lastRun: '2026-05-25 03:00', schedule: '每天 03:00', totalRuns: 30, totalRows: '28,400', totalSize: '8.6 MB', syncStrategy: 'incremental', incremental: { field: 'FModifyDate', lookback: '1 天' }, schemaMeta: '通过 WebAPI ExecuteBillQuery 查询 BD_MATERIAL',
        schema: [
      ...
      't_demo_salesforce': { name: '【示例】Salesforce Opportunity 同步', connector: '销售 · Salesforce', connType: 'Salesforce（企业应用）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / sf_opportunity', status: '载入失败', created: '2026-05-25 15:55', lastRun: '2026-05-25 14:00', schedule: '每小时', totalRuns: 720, totalRows: '12,400', totalSize: '4.2 MB', syncStrategy: 'incremental', incremental: { field: 'LastModifiedDate', lookback: '2 小时' }, schemaMeta: 'SOQL: SELECT ... FROM Opportunity WHERE LastModifiedDate > $watermark',
        schema: [
      ...
      // ---------- 协作平台 ----------
      't_demo_feishu': { name: '【示例】飞书群消息载入', connector: '团队飞书', connType: '飞书（协作平台）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / feishu_messages', status: '等待中', created: '2026-05-25 16:00', lastRun: '2026-05-25 14:00', schedule: '每 10 分钟', totalRuns: 4320, totalRows: '186,000', totalSize: '82 MB', syncStrategy: 'incremental', incremental: { field: 'create_time', lookback: '30 分钟' }, schemaMeta: 'open-apis/im/v1/messages · 按 chat_id 过滤白名单群组',
        schema: [
      ...
      't_demo_dingtalk': { name: '【示例】钉钉审批数据同步', connector: '集团钉钉', connType: '钉钉（协作平台）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / ding_approvals', status: '等待中', created: '2026-05-25 16:05', lastRun: '2026-05-25 14:00', schedule: '每小时', totalRuns: 720, totalRows: '38,200', totalSize: '14 MB', syncStrategy: 'incremental', incremental: { field: 'finish_time', lookback: '2 小时' }, schemaMeta: 'topapi/processinstance/listids + 详情拉取',
        schema: [
      ...
      't_demo_wecom_api': { name: '【示例】企业微信通讯录同步', connector: '企业微信项目通知 API', connType: '企业微信 API（协作平台）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / wecom_users', status: '等待中', created: '2026-05-25 16:10', lastRun: '2026-05-25 08:00', schedule: '每天 08:00', totalRuns: 30, totalRows: '4,800', totalSize: '1.6 MB', syncStrategy: 'full', schemaMeta: 'cgi-bin/user/simplelist + user/get；每日全量刷新通讯录',
        schema: [
      ...
      't_demo_slack': { name: '【示例】Slack 频道消息载入', connector: '海外团队 · Slack', connType: 'Slack（协作平台）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / slack_messages', status: '等待中', created: '2026-05-25 16:15', lastRun: '2026-05-25 14:00', schedule: '每 10 分钟', totalRuns: 4320, totalRows: '128,400', totalSize: '52 MB', syncStrategy: 'incremental', incremental: { field: 'ts', lookback: '30 分钟' }, schemaMeta: 'conversations.history · 监听白名单 channel 列表',
        schema: [
      ...
      't_demo_github': { name: '【示例】GitHub Issue 同步（matrixflow）', connector: 'matrixflow · GitHub', connType: 'GitHub（协作平台）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / github_issues', status: '等待中', created: '2026-05-25 16:20', lastRun: '2026-05-25 14:00', schedule: '每小时', totalRuns: 720, totalRows: '12,600', totalSize: '32 MB', syncStrategy: 'incremental', incremental: { field: 'updated_at', lookback: '2 小时' }, schemaMeta: 'GET /repos/matrixorigin/matrixflow/issues?since=$watermark',
        schema: [
      ...
      't_demo_yuque': { name: '【示例】语雀文档元数据同步', connector: '内部 · 语雀知识库', connType: '语雀（协作平台）', dataType: '结构化', mode: '周期性', target: 'default / 示例库 / yuque_docs', status: '等待中', created: '2026-05-25 16:25', lastRun: '2026-05-25 06:00', schedule: '每 6 小时', totalRuns: 120, totalRows: '2,840', totalSize: '8.4 MB', syncStrategy: 'incremental', incremental: { field: 'updated_at', lookback: '12 小时' }, schemaMeta: 'GET /api/v2/repos/:namespace/docs · 仅同步元数据，正文按需取',
        schema: [
...
window.IMPORT_TASKS_EDIT = {
      ...
      't_demo_aliyun_oss':  { name: '【示例】阿里云 OSS 营销素材同步', dataType: 'unstructured', sourceType: 'connector', connectorValue: 'aliyun-oss',  loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'hourly', target: { dir: 'default', db: '示例库', volume: '营销素材卷' }, targetMode: 'existing', syncStrategy: 'incremental', incremental: { field: '对象 LastModified', lookback: '1h' } },
      't_demo_s3':          { name: '【示例】AWS S3 数据归档（双向）',  dataType: 'unstructured', sourceType: 'connector', connectorValue: 's3',          loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'daily',  target: { dir: 'default', db: '示例库', volume: 'NESR 备份卷' }, targetMode: 'existing', syncStrategy: 'incremental', incremental: { field: 'S3 LastModified', lookback: '1d' } },
      't_demo_cos':         { name: '【示例】腾讯云 COS 课程视频载入', dataType: 'unstructured', sourceType: 'connector', connectorValue: 'tencent-cos', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'daily',  target: { dir: 'default', db: '示例库', volume: '视频素材卷' }, targetMode: 'existing', syncStrategy: 'incremental', incremental: { field: '对象 LastModified', lookback: '1d' } },
      't_demo_obs':         { name: '【示例】华为云 OBS 合规报告归档', dataType: 'unstructured', sourceType: 'connector', connectorValue: 'huawei-obs',  loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '7d',     target: { dir: 'default', db: '示例库', volume: '合规归档卷' }, targetMode: 'existing', syncStrategy: 'full' },
      't_demo_hdfs':        { name: '【示例】HDFS 行为日志载入',       dataType: 'unstructured', sourceType: 'connector', connectorValue: 'hdfs',        loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'hourly', target: { dir: 'default', db: '示例库', volume: '行为日志卷' }, targetMode: 'existing', syncStrategy: 'incremental', incremental: { field: '分区 dt/hr', lookback: '2h' }, backfill: true },

      // 数据库类（structured）
      't_demo_matrixone':   { name: '【示例】MatrixOne 用户行为表同步',  dataType: 'structured', sourceType: 'connector', connectorValue: 'matrixone',  loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'hourly', dbName: 'moi_warehouse', dbTable: 'user_events',          target: { dir: 'default', db: '示例库', table: 'user_events' },        targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'event_time', lookback: '1h' } },
      't_demo_mysql':       { name: '【示例】MySQL 用户中心同步',          dataType: 'structured', sourceType: 'connector', connectorValue: 'mysql',      loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'hourly', dbName: 'user_center',   dbTable: 'users',                target: { dir: 'default', db: '示例库', table: 'users' },              targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'updated_at', lookback: '1h' } },
      't_demo_pg':          { name: '【示例】PostgreSQL 财务汇总同步',     dataType: 'structured', sourceType: 'connector', connectorValue: 'postgresql', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'daily',  dbName: 'finance_dw',    dbTable: 'daily_financial_summary', target: { dir: 'default', db: '示例库', table: 'financial_summary' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'report_date', lookback: '7d' } },
      't_demo_mongodb':     { name: '【示例】MongoDB 商品目录同步',       dataType: 'structured', sourceType: 'connector', connectorValue: 'mongodb',    loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'hourly', dbName: 'shop_prod',     dbTable: 'products',             target: { dir: 'default', db: '示例库', table: 'products' },           targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'updatedAt', lookback: '1h' } },
      't_demo_hive':        { name: '【示例】Hive DWD 周报加工',         dataType: 'structured', sourceType: 'connector', connectorValue: 'hive',       loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '7d',     dbName: 'nesr_dw_dwd',   dbTable: 'dwd_well_kpi_hourly',  target: { dir: 'default', db: '示例库', table: 'dwd_weekly_kpi' },     targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'partition stat_week', lookback: '0' } },
      't_demo_sqlserver':   { name: '【示例】SQL Server 报价单同步',     dataType: 'structured', sourceType: 'connector', connectorValue: 'sqlserver',  loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '30m',    dbName: 'TopcastQuote',  dbTable: 'QUOTE_HDR',            target: { dir: 'default', db: '示例库', table: 'quote_orders' },       targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'LastModified', lookback: '30m' } },
      't_demo_oracle':      { name: '【示例】Oracle ERP 总账分录同步',   dataType: 'structured', sourceType: 'connector', connectorValue: 'oracle',     loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'daily',  dbName: 'ERPPDB1',       dbTable: 'GL_JE_LINES',          target: { dir: 'default', db: '示例库', table: 'gl_je_lines' },        targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'LAST_UPDATE_DATE', lookback: '1d' } },
      't_demo_clickhouse':  { name: '【示例】ClickHouse 港股 Tick 同步', dataType: 'structured', sourceType: 'connector', connectorValue: 'clickhouse', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '1m',     dbName: 'hkex_market',   dbTable: 'tick',                 target: { dir: 'default', db: '示例库', table: 'hkex_tick' },          targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'tick_time', lookback: '5m' }, backfill: true },
      't_demo_doris':       { name: '【示例】Doris 实时指标同步',         dataType: 'structured', sourceType: 'connector', connectorValue: 'doris',      loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '5m',     dbName: 'rt_analytics',  dbTable: 'minute_metrics',       target: { dir: 'default', db: '示例库', table: 'rt_metrics' },         targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'stat_time', lookback: '15m' } },

      // 邮件类
      't_demo_gmail':            { name: '【示例】Gmail 客户邮件载入',         dataType: 'structured', sourceType: 'connector', connectorValue: 'gmail',           loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '5m',  target: { dir: 'default', db: '示例库', table: 'gmail_messages' },   targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'internalDate', lookback: '15m' } },
      't_demo_outlook':          { name: '【示例】Outlook 法务邮件载入',       dataType: 'structured', sourceType: 'connector', connectorValue: 'outlook',         loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '15m', target: { dir: 'default', db: '示例库', table: 'outlook_messages' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'receivedDateTime', lookback: '30m' } },
      't_demo_ms365_graph':      { name: '【示例】Microsoft 365 全员邮件采集', dataType: 'structured', sourceType: 'connector', connectorValue: 'ms365-graph',     loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '5m',  target: { dir: 'default', db: '示例库', table: 'ms365_messages' },   targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'receivedDateTime', lookback: '15m' }, backfill: true },
      't_demo_wecom_mail':       { name: '【示例】企业微信邮箱采集',           dataType: 'structured', sourceType: 'connector', connectorValue: 'wecom-mail',      loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '10m', target: { dir: 'default', db: '示例库', table: 'wecom_mail_messages' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'mail_date', lookback: '30m' } },
      't_demo_qq_mail':          { name: '【示例】QQ 邮箱采集',                dataType: 'structured', sourceType: 'connector', connectorValue: 'qq-mail',         loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '10m', target: { dir: 'default', db: '示例库', table: 'qq_mail_messages' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'mail_date', lookback: '30m' } },
      't_demo_imap':             { name: '【示例】内部 IMAP 邮箱采集',         dataType: 'structured', sourceType: 'connector', connectorValue: 'imap-smtp',       loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'hourly', target: { dir: 'default', db: '示例库', table: 'internal_mail' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'received_at', lookback: '2h' } },
      't_demo_custom_mail_api':  { name: '【示例】自有邮件 API 同步',          dataType: 'structured', sourceType: 'connector', connectorValue: 'custom-mail-api', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '5m',  target: { dir: 'default', db: '示例库', table: 'custom_mail' },   targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'sent_at', lookback: '15m' } },

      // API
      't_demo_rest_api':    { name: '【示例】天气 API 拉取',          dataType: 'structured', sourceType: 'connector', connectorValue: 'rest-api', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'hourly', apiEndpoint: '/weather', target: { dir: 'default', db: '示例库', table: 'weather_hourly' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'obs_time', lookback: '2h' } },
      't_demo_graphql':     { name: '【示例】GraphQL 电商订单同步',  dataType: 'structured', sourceType: 'connector', connectorValue: 'graphql',  loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '15m',    apiEndpoint: 'query orders', target: { dir: 'default', db: '示例库', table: 'shop_orders' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'updatedAt', lookback: '30m' } },

      // 文件协议（unstructured）
      't_demo_ftp':         { name: '【示例】FTP 现场日报载入',      dataType: 'unstructured', sourceType: 'connector', connectorValue: 'ftp',        loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'daily',  target: { dir: 'default', db: '示例库', volume: '现场日报卷' }, targetMode: 'existing', syncStrategy: 'incremental', incremental: { field: '文件 mtime', lookback: '1d' } },
      't_demo_sftp':        { name: '【示例】SFTP 客户合同同步',     dataType: 'unstructured', sourceType: 'connector', connectorValue: 'sftp',       loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'daily',  target: { dir: 'default', db: '示例库', volume: '合同档案卷' }, targetMode: 'existing', syncStrategy: 'incremental', incremental: { field: '文件 mtime', lookback: '1d' } },
      't_demo_sharepoint':  { name: '【示例】SharePoint 问卷文档载入',dataType: 'unstructured', sourceType: 'connector', connectorValue: 'sharepoint', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '6h',     target: { dir: 'default', db: '示例库', volume: '问卷文档卷' }, targetMode: 'existing', syncStrategy: 'incremental', incremental: { field: 'Modified', lookback: '6h' } },
      't_demo_smb':         { name: '【示例】NAS 部门资料同步',      dataType: 'unstructured', sourceType: 'connector', connectorValue: 'smb-nas',    loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'hourly', target: { dir: 'default', db: '示例库', volume: '部门资料卷' }, targetMode: 'existing', syncStrategy: 'incremental', incremental: { field: '文件 mtime', lookback: '2h' } },

      // 消息队列（structured + 实时）
      't_demo_kafka':       { name: '【示例】Kafka GPS 流实时摄取',  dataType: 'structured', sourceType: 'connector', connectorValue: 'kafka',    loadMode: 'realtime', stLoadMode: 'realtime', apiEndpoint: 'taxi.gps.*', target: { dir: 'default', db: '示例库', table: 'gps_events' },        targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'Kafka offset', lookback: '5m' } },
      't_demo_mqtt':        { name: '【示例】MQTT IoT 设备遥测',     dataType: 'structured', sourceType: 'connector', connectorValue: 'mqtt',     loadMode: 'realtime', stLoadMode: 'realtime', apiEndpoint: 'iot/+/telemetry', target: { dir: 'default', db: '示例库', table: 'iot_telemetry' },     targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'ts', lookback: '10m' } },
      't_demo_rabbitmq':    { name: '【示例】RabbitMQ 通知事件消费', dataType: 'structured', sourceType: 'connector', connectorValue: 'rabbitmq', loadMode: 'realtime', stLoadMode: 'realtime', apiEndpoint: 'moi.notifications', target: { dir: 'default', db: '示例库', table: 'notification_events' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'queue offset', lookback: '5m' } },

      // 企业应用
      't_demo_sap':         { name: '【示例】SAP S/4HANA 销售订单同步',   dataType: 'structured', sourceType: 'connector', connectorValue: 'sap-s4hana', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'daily',  apiEndpoint: '/API_SALES_ORDER_SRV/A_SalesOrder', target: { dir: 'default', db: '示例库', table: 'sap_sales_orders' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'LAST_CHANGE_DATE', lookback: '1d' } },
      't_demo_oracle_erp':  { name: '【示例】Oracle ERP Cloud GL 同步',   dataType: 'structured', sourceType: 'connector', connectorValue: 'oracle-erp', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'daily',  apiEndpoint: '/generalLedgerBalances',            target: { dir: 'default', db: '示例库', table: 'erp_gl_balances' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'LastUpdateDate', lookback: '1d' } },
      't_demo_u8':          { name: '【示例】用友 U8 销售订单同步',       dataType: 'structured', sourceType: 'connector', connectorValue: 'yonyou-u8',  loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'daily',  dbName: '001(2026)', dbTable: 'SO_SOMain',                target: { dir: 'default', db: '示例库', table: 'u8_sale_orders' },     targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'cmodifytime', lookback: '1d' } },
      't_demo_kingdee':     { name: '【示例】金蝶 K3 物料主数据同步',     dataType: 'structured', sourceType: 'connector', connectorValue: 'kingdee-k3', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'daily',  apiEndpoint: 'BD_MATERIAL',                       target: { dir: 'default', db: '示例库', table: 'kingdee_materials' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'FModifyDate', lookback: '1d' } },
      't_demo_salesforce':  { name: '【示例】Salesforce Opportunity 同步',dataType: 'structured', sourceType: 'connector', connectorValue: 'salesforce', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'hourly', apiEndpoint: 'SOQL Opportunity',                  target: { dir: 'default', db: '示例库', table: 'sf_opportunity' },   targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'LastModifiedDate', lookback: '2h' } },

      // 协作平台
      't_demo_feishu':      { name: '【示例】飞书群消息载入',        dataType: 'structured', sourceType: 'connector', connectorValue: 'feishu',   loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '10m',   apiEndpoint: '/im/v1/messages',     target: { dir: 'default', db: '示例库', table: 'feishu_messages' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'create_time', lookback: '30m' } },
      't_demo_dingtalk':    { name: '【示例】钉钉审批数据同步',      dataType: 'structured', sourceType: 'connector', connectorValue: 'dingtalk', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'hourly', apiEndpoint: '/processinstance',    target: { dir: 'default', db: '示例库', table: 'ding_approvals' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'finish_time', lookback: '2h' } },
      't_demo_wecom_api':   { name: '【示例】企业微信通讯录同步',    dataType: 'structured', sourceType: 'connector', connectorValue: 'wecom-api',loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'daily',  apiEndpoint: '/cgi-bin/user/list',  target: { dir: 'default', db: '示例库', table: 'wecom_users' },    targetMode: 'new', syncStrategy: 'full' },
      't_demo_slack':       { name: '【示例】Slack 频道消息载入',    dataType: 'structured', sourceType: 'connector', connectorValue: 'slack',    loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '10m',   apiEndpoint: 'conversations.history', target: { dir: 'default', db: '示例库', table: 'slack_messages' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'ts', lookback: '30m' } },
      't_demo_github':      { name: '【示例】GitHub Issue 同步（matrixflow）', dataType: 'structured', sourceType: 'connector', connectorValue: 'github', loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: 'hourly', apiEndpoint: '/repos/matrixorigin/matrixflow/issues', target: { dir: 'default', db: '示例库', table: 'github_issues' }, targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'updated_at', lookback: '2h' } },
      't_demo_yuque':       { name: '【示例】语雀文档元数据同步',    dataType: 'structured', sourceType: 'connector', connectorValue: 'yuque',    loadMode: 'periodic', stLoadMode: 'periodic', stPeriodicInterval: '6h',    apiEndpoint: '/api/v2/repos/:ns/docs', target: { dir: 'default', db: '示例库', table: 'yuque_docs' },   targetMode: 'new', syncStrategy: 'incremental', incremental: { field: 'updated_at', lookback: '12h' } }
    };
})();
