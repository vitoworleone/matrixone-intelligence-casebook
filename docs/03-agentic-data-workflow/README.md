...
The runnable demo belongs in `apps/agentic-workflow-demo/`. Its workflow definition must be readable without running the app, and every tool must have a documented input/output contract.
