...
本目录保存与 RAG 架构文档对应的源码快照，来源版本为 Matrixflow 提交 `d4b7995fabb906cf2c492a9d27ac0680e60fbee6`。文件保留原始目录层级，便于从文档直接跳转到实现与测试。快照内 278 个源文件均可通过 [SHA-256 清单](SOURCE-MANIFEST.tsv)核对。
